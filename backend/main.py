...
PT_BR_QUOTES = [
    {
        "quote": "Você não precisa resolver tudo hoje. Um passo possível já é movimento.",
        "author": "Vibra9"
    },
    {
    ...
    {
        "quote": "Clareza começa quando você reduz o excesso e escolhe o essencial.",
        "author": "Vibra9"
    },
    {
        "quote": "Pequenas ações consistentes constroem mudanças reais.",
        "author": "Vibra9"
    },
    {
        "quote": "Nem todo dia precisa ser intenso. Alguns dias pedem presença e gentileza.",
        "author": "Vibra9"
    },
    {
        "quote": "Antes de se cobrar mais, observe o que você já está sustentando.",
        "author": "Vibra9"
    },
    {
        "quote": "Equilíbrio não é fazer tudo. É reconhecer o que precisa de cuidado agora.",
        "author": "Vibra9"
    },
    {
        "quote": "Respire, organize o próximo passo e siga sem pressa.",
        "author": "Vibra9"
    },
    {
        "quote": "Seu bem-estar também se constrói nas escolhas pequenas do dia.",
        "author": "Vibra9"
    },
    {
        "quote": "Você pode recomeçar de forma simples, sem transformar tudo de uma vez.",
        "author": "Vibra9"
    },
    {
        "quote": "Pausar não é desistir. Às vezes é a forma mais inteligente de continuar.",
        "author": "Vibra9"
    },
    {
        "quote": "O que se repete merece atenção, não culpa.",
        "author": "Vibra9"
    }
]
...
async def get_external_quote() -> Dict[str, str]:
    index = datetime.now(timezone.utc).timetuple().tm_yday % len(PT_BR_QUOTES)
    return PT_BR_QUOTES[index]
