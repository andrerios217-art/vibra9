...
class _DeepCheckinScreenState extends State<DeepCheckinScreen> {
  ...
  final List<_QuestionItem> questions = const [
    ...
    _QuestionItem("Minha mente tem parecido mais cheia do que o normal.", "Mental", true),
    ...
    _QuestionItem("Minhas relações têm sido mais leves do que confusas.", "Relações", false),
    _QuestionItem("Tenho me sentido inseguro(a) em algumas relações.", "Relações", true),
    _QuestionItem("Tenho tido interações agradáveis no dia a dia.", "Relações", false),
    _QuestionItem("Algumas interações têm me deixado mais cansado(a).", "Relações", true),
    _QuestionItem("Sinto que faço parte de algum ambiente.", "Pertencimento", false),
    ...
    _QuestionItem("Minhas escolhas fazem sentido para mim.", "Propósito", false),
    _QuestionItem("Minha rotina tem fluído de forma razoável.", "Rotina", false),
    ...
    _QuestionItem("Tenho conseguido me adaptar quando o dia muda.", "Flexibilidade", false),
    _QuestionItem("Tenho tido momentos leves no meio da rotina.", "Leveza", false),
    _QuestionItem("Percebo evolução no que faço.", "Evolução", false),
    ...
    _QuestionItem("Sinto troca nas minhas relações.", "Relações", false),
    _QuestionItem("Sinto que as coisas estão equilibradas.", "Equilíbrio", false),
  ];
  ...
  final List<String> followUp = const [
    ...
    "Minha mente parece sempre ocupada.",
    ...
    "Tenho dificuldade em concluir tarefas.",
    "Sinto excesso de pensamentos ao mesmo tempo.",
  ...
  Future<void> saveDeepCheckin() async {
    if (savingDeepCheckin || savedDeepCheckinId != null) {
      return;
    }
  ...
  String resultText(int score) {
    ...
    if (score <= 70) {
      return "Seu momento parece misturar recursos positivos com alguns pontos de desgaste. Há sinais de funcionamento, mas também necessidade de reorganizar energia, foco e limites.";
    }
  ...
  Widget build(BuildContext context) {
    ...
    if (step == "follow") {
      return _QuestionStep(
        title: "Só mais algumas perguntas rápidas",
        subtitle: "Essas perguntas ajudam a entender melhor sua carga mental.",
...
class _IntroStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Check-up ampliado"),
      ),
      body: SafeArea(
        child: ListView(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "Responda algumas perguntas sobre energia, foco, emoções, relações e rotina para entender melhor seu momento atual.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 15,
                      height: 1.45,
                  ...
                  const _IntroInfoCard(
                    ...
                    title: "Mais clareza",
                    text: "Identifique sinais de sobrecarga e desequilíbrio.",
                  ),
                  const _IntroInfoCard(
                    icon: Icons.auto_awesome_rounded,
                    title: "Mais consciência",
                    text: "Perceba como áreas da vida influenciam seu bem-estar.",
                  ),
                  const _IntroInfoCard(
                    icon: Icons.favorite_rounded,
                    title: "Mais cuidado",
                    text: "Receba uma orientação simples para hoje.",
                  ),
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            "Estamos organizando suas respostas em uma leitura simples de bem-estar.",
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 14,
              height: 1.4,
...
class _ResultStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF8F5FF),
      appBar: AppBar(
        title: const Text("Resultado ampliado"),
      ),
      body: SafeArea(
        child: ListView(
          padding: const EdgeInsets.all(22),
